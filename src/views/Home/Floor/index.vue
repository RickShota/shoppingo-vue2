      ...
      <div class="title clearfix">
        ...
        <div class="fr">
          <ul class="nav-tabs clearfix">
            <li class="active" v-for="item in floorList.navList" :key="item.id">
      ...
      <div class="tab-content">
        <div class="tab-pane">
          <div class="floor-1">
            <div class="blockgary">
              <ul class="jd-list">
                <li v-for="item in floorList.keywords" :key="item.index">{{ item }}</li>
              </ul>
              <img :src="floorList.imgUrl" alt=""/>
            </div>
            <div class="floorBanner">
              <!--轮播图-->
              <my-carousel :list="floorList.carouselList" :id="floorList.id"></my-carousel>
            </div>
            <div class="split">
